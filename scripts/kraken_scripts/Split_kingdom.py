...
"This script will split kraken-mpa output based on kingdom in the merged kraken files aka split original file based on wether the abundance line belings to Bacteria, Virus, Archea, or Eukaryota (Protist and fungi)"
...
inputfile=str(args.input) #name of input file '-i'
                               
#--------Create new directory for file output-----
path=str(args.output) #name of new output directory
