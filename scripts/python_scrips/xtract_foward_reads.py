...
import argparse
'''Script allows you to extract the fowards reads that did not merge in the bbmerge. AKA from you unmerged file'''
...
for line in fin:
    ...
    if line.startswith('>'):
       ...
       # print header
        ...
        fastaseq+=line.strip('\n').strip('\t').strip()# continue to add strings to your variable fastaseq until it sees the > character and is restarted with an empty string
