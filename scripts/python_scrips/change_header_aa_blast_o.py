...
headers should include PROTEIN Accesion number followed by full taxonomic lineage as well as species specificity. Changed outptu will be from and to a balst output txt style file"""
...
for line in fin1:
    handle = Entrez.efetch(db="protein", id=str(line), rettype="gb", retmode="text")
